...
// Write your own javascript validation function to check 
// if the entered value is a valid email address. 
...
document.querySelector("form").addEventListener('submit',checkMail)
